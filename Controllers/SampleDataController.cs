...
namespace PriceAdvisor.Controllers
{
    ...
    public class SampleDataController : Controller
    {
        ...
        {
           BackgroundJob.Enqueue(() => this.GetDataFromSkytech());
           BackgroundJob.Enqueue(() => this.GetDataFromKilobaitas());
           BackgroundJob.Enqueue(() => this.GetDataFromFortakas());
           BackgroundJob.Enqueue(() => this.GetDataFromTopoCentras());
           RecurringJob.AddOrUpdate(() => this.GetAllData(),Cron.Daily);          
        }
        [HttpGet("[action]")]
        [Route("skytech")]
        //[Authorize]
